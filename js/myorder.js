            ...
            container.innerHTML += `
                <div class="order-card">
                    ...
                    <div class="order-info">
                        ...
                        <p class="admin-note">If you are not satisfied with this order, you can chat with admin for support.</p>
                    </div>
                    <div class="order-footer">
                        ...
                        <div class="button-group">
                            ...
                            <button class="btn-chat-admin" onclick="startAdminChatSession(${orderId})">Chat Admin</button>
                        </div>
                    </div>
                </div>
            `;
