...
function buildPaymentFormData(bookingData, method, passwordValue) {
    ...
    const resolvedVendorId = bookingData.vendorId || bookingData.vendor_id || urlParams.get("vendorId") || urlParams.get("vendor_id") || "SOS_BROADCAST";
    const resolvedServiceId = bookingData.service_id || bookingData.serviceId || bookingData.selectedServiceId || urlParams.get("service_id") || urlParams.get("serviceId") || "0";
    const resolvedService = bookingData.service || bookingData.servicename || bookingData.serviceName || "Service";
    const resolvedSubservice = bookingData.subservicebooked || bookingData.subserviceBooked || bookingData.subservice || bookingData.service || bookingData.serviceName || "";
    ...
    formData.append("service", resolvedService);
    formData.append("category", bookingData.category || "");
    formData.append("vendorId", resolvedVendorId);
    formData.append("vendor_id", resolvedVendorId);
    formData.append("service_id", resolvedServiceId);
    formData.append("serviceId", resolvedServiceId);
    formData.append("subservicebooked", resolvedSubservice);
